package php.index.demo.com.tutorialsninja.www.testsuite;

import org.openqa.selenium.By;
import org.testng.Assert;
import org.testng.annotations.Test;
import php.index.demo.com.tutorialsninja.www.pages.*;
import php.index.demo.com.tutorialsninja.www.testbase.BaseTest;
...
public class LoginTest extends BaseTest {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() {
        ...
        laptopAndNotebooksPage.mouseHooverOnElement(By.xpath("//label[contains(text(),'Sort By:')]"));
        laptopAndNotebooksPage.clickOnElement(By.xpath("//option[contains(text(),'Price (High > Low)')]"));
        ...
        laptopAndNotebooksPage.assertVeriifyPage(By.xpath("//h1[normalize-space()='MacBook']"), "MacBook");
